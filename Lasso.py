...
def plot_all_cms(results_dict, theory_cm, method_name):
    # 設定畫布
    ...
    #畫出理論模型的CM
    sns.heatmap(theory_cm, annot=True, fmt='d', cmap='Greens', ax=axes[3])
    axes[3].set_title('Theory Lambda')
...
#執行
plot_all_cms(ros_results, theory_ros_cm, "ROS")
plot_all_cms(smote_results, theory_smote_cm, "SMOTE")
plot_all_cms(weighted_results, theory_weighted_cm, "Weighted")